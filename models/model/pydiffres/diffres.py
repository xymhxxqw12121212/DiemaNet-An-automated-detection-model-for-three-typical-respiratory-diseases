...
from .dilated_convolutions_1d.conv import DilatedConv, DilatedConv_Out_128
...
class DiffRes(Base):
    ...
    def forward(self, x):
        ...
        mean_feature = self.frame_warping(
...
class ConvAvgPool(Base):
    def __init__(
        ...
        self.model = DilatedConv_Out_128(in_channels=self.input_f_dim, dilation_rate=1,
                                         input_size=self.input_seq_length, kernel_size=5, stride=1)
