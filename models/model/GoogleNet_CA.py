...
class GoogleNet_CA(nn.Module):
    def __init__(self, num_classes=1000, aux_logits=True, init_weights=False):
        super(GoogleNet_CA, self).__init__()
...
class GoogleNet_openl_CA(nn.Module):
    def __init__(self, num_classes=1000, aux_logits=True, init_weights=False):
        super(GoogleNet_openl_CA, self).__init__()
        self.aux_logits = aux_logits
...
if __name__ == '__main__':
    ...
    # model = GoogleNet_CA(num_classes=4, aux_logits=True, init_weights=True)
    model = GoogleNet_openl_CA(num_classes=4, aux_logits=True, init_weights=True)
    y=model(b)
    print(y.shape)